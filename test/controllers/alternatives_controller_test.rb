...
class AlternativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alternative" do
    assert_difference('Alternative.count') do
      post alternatives_url, params: { alternative: { tovar_id: @alternative.tovar_id, value: @alternative.value, xpath: @alternative.xpath } }
    end
  ...
  test "should update alternative" do
    patch alternative_url(@alternative), params: { alternative: { tovar_id: @alternative.tovar_id, value: @alternative.value, xpath: @alternative.xpath } }
